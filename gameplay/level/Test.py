...
class Test(object):
    ...
    def __init__(self):
        ...
        self.player.sprite.x, self.player.sprite.y = 312, 350
        ...
        self.entities.append(gameplay.entity.Skeleton(self, [812, 350]))
        self.entities.append(gameplay.entity.Skeleton(self, [300, 500]))
